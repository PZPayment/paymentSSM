...
public class PaymentProviderImpl  implements PaymentProvider{
    ...
    @Override
    public PaymentResultBO realTimePayment(PaymentBO paymentBO) throws PaymentException {
        return null;
    }

    @Override
    public PaymentResultBO guaranteePayment(PaymentBO paymentBO) throws PaymentException {
        return null;
    }
