package com.payment.comm.utils.alipaymobile.util.httpClient;
...
/**
 * 类名：HttpProtocolHandler 功能：HttpClient方式访问 详细：获取远程HTTP数据 版本：3.3 日期：2012-08-17
...
public class HttpProtocolHandler {
    ...
    /**
     * 闲置连接超时时间, 由bean factory设置，缺省为0.03秒钟
     */
    private int defaultMaxConnPerHost = 30;
    /**
     * 闲置连接超时时间, 由bean factory设置，缺省为0.08秒钟
     */
