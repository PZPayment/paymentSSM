package com.payment.comm.utils.alipaymobile.util;

import com.payment.comm.utils.MyLogger;
import com.payment.comm.utils.alipaymobile.config.AlipayConfig;
import com.payment.comm.utils.alipaymobile.sign.RSA;
import com.payment.comm.utils.alipaymobile.util.httpClient.HttpProtocolHandler;
import com.payment.comm.utils.alipaymobile.util.httpClient.HttpRequest;
import com.payment.comm.utils.alipaymobile.util.httpClient.HttpResponse;
import com.payment.comm.utils.alipaymobile.util.httpClient.HttpResultType;
...
/**
 * 类名：AlipaySubmit 功能：支付宝各接口请求提交类 详细：构造支付宝各接口表单HTML文本，获取远程HTTP数据 版本：3.3
 * 日期：2012-08-13 说明： 以下代码只是为了方便商户测试而提供的样例代码，商户可以根据自己网站的需要，按照技术文档编写,并非一定要使用该代码。
