package com.payment.comm.utils.wxap.util;
...
public class HttpClientUtil {
    ...
    public static final MyLogger LOGGER = new MyLogger(HttpClientUtil.class);
     ...
     * @throws IOException
     */
    public static Certificate getCertificate(File cafile) throws CertificateException{
     ...
     * @throws IOException
     */
    public static void storeCACert(Certificate cert, String alias, String password, OutputStream out) throws KeyStoreException, NoSuchAlgorithmException, CertificateException,
            IOException {
