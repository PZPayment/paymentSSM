package com.payment.comm.utils.tenpay.client;

import com.payment.comm.utils.tenpay.util.HttpClientUtil;
...
public class TenpayHttpClient {
    ...
    /** 记录日志对象 */
    private static final Logger LOGGER = Logger.getLogger(TenpayHttpClient.class);
    /**
     * ca证书文件
     */
    private File caFile;
